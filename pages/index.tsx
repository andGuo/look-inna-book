      ...
      <div className="flex flex-wrap flex-col items-center justify-center">
        ...
        <div className="mt-4 sm:w-1/2">
          <form className="flex items-center" onSubmit={e => { e.preventDefault(); searchForBooks(searchQuery);}}>
            ...
            <button
              type="button"
              className="p-2.5 ml-2 text-sm font-medium text-white bg-draculaPink rounded-lg border hover:bg-draculaPurple focus:ring-4 focus:outline-none focus:bg-draculaPurple"
